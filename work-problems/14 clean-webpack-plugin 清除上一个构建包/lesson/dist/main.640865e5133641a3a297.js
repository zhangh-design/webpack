...
/* harmony import */ var lodash_join__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(0);
...
const dom = $('<div>')
dom.html(lodash_join__WEBPACK_IMPORTED_MODULE_0___default()(['hello','world','bye'], ' --- '));
$('body').append(dom);
