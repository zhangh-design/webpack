...
module.exports = {
  ...
  isDevCssOneStyle: false, // dev 模式下最终的 css 是否要合并到一个 <style></style> 标签内，默认 false 每一次处理引入的样式文件都会在 DOM 上创建一个 <style> 标签
  isProdCssInline: true, // prod 模式下最终的 css 是否要内联到 style 标签内，默认 false 使用 link 引入
